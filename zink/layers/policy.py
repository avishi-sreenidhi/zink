...
"""
zink/layers/policy.py
---------------------
Policy — business rules and rate limiting.

Evaluation order:
    1. Policy rules  — AST-evaluated conditions, first block wins
    2. Rate limits   — stateful SQLite counter, post_execute increments
...
from zink.layers.condition_evaluator import evaluate_policies
